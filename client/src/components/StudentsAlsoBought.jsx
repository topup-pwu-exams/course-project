...
const StudentsAlsoBought = ({ title, author, mainImage, duration, lessons, price, likes, users, tags, categories, slug }) => {
    return (
         ...
         <NavLink to={`/course/${slug}`}>
            ...
            <div className='flex flex-row w-175 gap-4'>
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex'>
                        <span className='text-xs flex flex-row justify-center font-medium'>43 static hours | </span>
                        <span className='text-xs flex flex-row justify-center font-light ml-2'> Published at  </span>
                    </div>
                </div>
                ...
                <p className='text-sm flex flex-row justify-center font-semibold'>price</p>
                </div>
            </div>
            <div>
