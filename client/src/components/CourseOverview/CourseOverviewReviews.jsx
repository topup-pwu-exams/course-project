    ...
    return (
        ...
        <div className='mx-10'>
            <div className='mx-10 mt-8'>
                ...
                <div>
                    <form className='border p-3 flex flex-row w-96'>
                        <input type="text" placeholder='Search reviews (why?)' className='w-80' />
                        <button type='submit'>
                            <SearchCircleIcon className='w-8' />
                        </button>
                    </form>
                </div>
                <div className='flex  flex-row items-start my-5 gap-4'>
                    ...
                    <div>
                        <p className='text-base text-left font-bold text-neutral-500 leading-5'>Reveiwer</p>
                        ...
                        <p className='font-light ml-2'>a month ago</p>
                        </div>
                    <div>
                        <p className='mt-2'>sd</p>
                    </div>
                    </div>
                </div>
            </div>
