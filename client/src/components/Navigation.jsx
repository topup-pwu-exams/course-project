            ...
            <div className='flex items-center space-x-8 border-l-2 border-gray-300 m-2 text-gray-500'>
                ...
                {isAuthenticated && (
                    <>
                        ...
                        <div onClick={() => logout({ returnTo: window.location.origin })} className='ml-8 flex flex-row hover:border-transparent rounded-full border-2 border-purple-500 bg-white text-purple-500 hover:text-white hover:bg-purple-500 px-3 py-1 hover:cursor-pointer'>
