...
function InfoCard({text}) {
  return (
    <div className='border-2 border-white shadow-md w-1/4 rounded-2xl bg-white'>
        <div className='p-5'>
          <div className='flex flex-col justify-center items-center text-center my-10 mx-5'>
            <div className='w-16 h-16 rounded-full hover:bg-white flex items-center justify-center'>
              <DesktopComputerIcon className='w-10 h-10 text-neutral-500 mx-auto overflow-hidden '/>
            </div>
